...
const adamModule = lessons.map((a) => a.length).slice(1, 23);
const przemekModule = lessons.map((a) => a.length).slice(23, 47);
const marcinModule = lessons.map((a) => a.length).slice(47);
console.log(adamModule);
console.log(przemekModule);
console.log(marcinModule);
